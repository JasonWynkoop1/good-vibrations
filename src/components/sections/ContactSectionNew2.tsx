...
export function ContactSection({ sectionRef }: ContactSectionProps) {
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-20 max-w-4xl mx-auto px-4 animate-fade-in">
            ...
            <div className="lg:col-span-8 p-6 md:p-10 lg:p-12">
              <div>
                ...
                {submissionStatus === 'success' ? (
                  <div className="bg-emerald-50 border-l-4 border-emerald-400 rounded-xl p-6 mb-6 shadow-md">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                    {submissionStatus === 'error' && (
                      <div className="bg-rose-50 border-l-4 border-rose-400 rounded-xl p-6 mb-4 shadow-md">
                        <div className="flex items-center">
