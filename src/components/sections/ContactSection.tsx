    ...
    <section ref={sectionRef} id="contact" className="container py-12 md:py-24 lg:py-32 mt-4 md:mt-8 relative overflow-hidden px-4 sm:px-6">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground text-base md:text-lg max-w-3xl mx-auto">
          Get in touch to schedule a visit or learn how we can help with your communication needs
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-8 md:gap-16 md:grid-cols-12 items-start">
        <div className="md:col-span-5 lg:col-span-4">
          <div className="bg-white/40 backdrop-blur-sm p-5 md:p-8 rounded-2xl border border-primary/20 shadow-md">
            <h3 className="text-xl font-semibold mb-6 text-primary">Corporate Headquarters</h3>
            <div className="space-y-4 md:space-y-6">
              <div className="flex items-center p-3 md:p-4 bg-white/60 backdrop-blur-sm rounded-xl shadow-sm hover:shadow-md hover:bg-white/80 transition-all duration-300 border border-primary/10 transform hover:translate-x-2 hover:translate-y-[-2px]">
                ...
                <div className="ml-3 md:ml-4">
                  ...
                  <a href="mailto:goodvibrations.speech@gmail.com" className="text-primary hover:underline font-medium text-sm md:text-base break-all">
                    info@goodvibrations.com
                  </a>
                </div>
              </div>
            ...
            <div className="mt-8 pt-8 border-t border-primary/10">
              ...
              <div className="flex space-x-3">
                <a href="#" aria-label="Facebook" className="w-8 h-8 flex items-center justify-center rounded-full bg-white/70 text-muted-foreground hover:text-primary hover:bg-white transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                  </svg>
                </a>
                <a href="#" aria-label="LinkedIn" className="w-8 h-8 flex items-center justify-center rounded-full bg-white/70 text-muted-foreground hover:text-primary hover:bg-white transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <form className="space-y-5">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <Label htmlFor="terms" className="text-xs text-muted-foreground">
                    By submitting this form, I agree to Good Vibrations' <a href="#" className="text-primary hover:underline">Privacy Policy</a> and consent to being contacted regarding my inquiry.
                  </Label>
                </div>
