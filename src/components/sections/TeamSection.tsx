          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-1 p-5">
              ...
              <div className="flex justify-center space-x-3 mt-4">
                <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-white/70 text-muted-foreground hover:text-primary hover:bg-white transition-colors">
