      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#services" className="text-sm text-muted-foreground hover:text-primary transition-colors">District-Wide Speech Services</a></li>
              <li><a href="#services" className="text-sm text-muted-foreground hover:text-primary transition-colors">School-Based Language Programs</a></li>
              <li><a href="#services" className="text-sm text-muted-foreground hover:text-primary transition-colors">Special Education Assessments</a></li>
            </ul>
          </div>
          <div>
